<?php /* Smarty version Smarty-3.1.7, created on 2014-10-24 09:02:56
         compiled from "/vhost/7/0/9/net70934927/www/phase2/admin/view/signupin_dosignin.html" */ ?>
<?php /*%%SmartyHeaderCode:14889652455449a54005a8c8-37382970%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4becd6064580e7e3fa8fc3c0fa28e16d51366952' => 
    array (
      0 => '/vhost/7/0/9/net70934927/www/phase2/admin/view/signupin_dosignin.html',
      1 => 1414109913,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '14889652455449a54005a8c8-37382970',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5449a540213c8',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5449a540213c8')) {function content_5449a540213c8($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ('header.html', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
        ...
        <table width="100%" border="0px" cellpadding="0" cellspacing="0" style="background:transparent;">
                ...
                <tr>
                  <td  style="text-align:center;" colspan="3" height="80" valign="top"></td>
                    ...
                    <tr>
                      <td>&nbsp;</td>
                      <td width="30%" height="40"><img src="../img/icon-demo.gif" width="16" height="16"><a href="./ido.php?tbl=info_helptbl&tit=帮助说明" target="_blank" class="left_txt3"> 使用说明</a> </td>
...
" method="post">
                        <table cellSpacing="0" cellPadding="0" width="100%" border="0" height="143" id="table212" style="background:transparent;">
