 ...
 */
 ...
 var UFQIE = {
	...
	//-- init 
 	init: function(taID,needConfirm, win)
	{	
		var u = UFQIE;
		var realinit=1;
        ...
        //win.alert('1win:['+win+'] ufe-win:['+u.win+'] window:['+u.window+'] window-bare:['+window+']');
        u.win.console = win.console;
        //u.win.alert('22win:['+win+'] ufe-win:['+u.win+'] document:['+document+']');
        win.console.log('1win:['+win+'] ufe-win:['+u.win+']');
        u.win.console.log('2win:['+win+'] ufe-win:['+u.win+'] ta:['+document.getElementById(taID)+']');
			...
			if(iscfrm){
				if(u.dtcobj(taID)){
					...
					if(!u.dtcobj(u.tlid)){
						...
						u.ta_y=ta.offsetTop;	
						u.win.alert('UFQIE.init: ta_x:['+u.ta_x+'] ta_y:['+u.ta_y+']');
						...
						if(u.dtcobj(u.tlid)){
							...
							if(true){
								...
								u.ta_x=tmpp.left;
								u.ta_y=tmpp.top;
								u.win.console.log('UFQIE.init: tlobj: ta_x:['+u.ta_x+'] ta_y:['+u.ta_y+']');
	...
	getDivPos: function(tObj)
	{
	     ...
	     {
		     UFQIE.win.alert('Ooops, ['+tObj.offsetLeft+'] ['+document.body.offsetLeft+'] offsetLeft && offsetTop not supported with '
			     + tObj.nodeName + ' in '
			     + UFQIE.win.navigator.appName + ' : '
			     + UFQIE.win.navigator.appVersion);
	     }
